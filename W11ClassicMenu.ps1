...
# 配置参数
$zipUrl = "https://cdn.jsdmirror.com/gh/huibsoft/static/Windows11_Classic_Context_Menu_v1.2.zip"
$targetDir = Join-Path $HOME 'Windows11_Classic_Context_Menu_v1.2'
$zipFileName = "Windows11_Classic_Context_Menu_v1.2.zip"
...
Write-Host ""
Write-Host "Windows 11 Classic Context Menu v1.2" -ForegroundColor Cyan
Write-Host ""
