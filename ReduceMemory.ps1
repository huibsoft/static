...
# 配置参数
$zipUrl = "https://cdn.jsdmirror.com/gh/huibsoft/static/Reduce_Memory_v1.7.zip"
$targetDir = Join-Path $HOME 'Reduce_Memory_v1.7'
$zipFileName = "Reduce_Memory_v1.7.zip"
...
Write-Host ""
Write-Host "Reduce Memory v1.7" -ForegroundColor Cyan
Write-Host ""
