...
# 配置参数
$zipUrl = "https://cdn.jsdmirror.com/gh/huibsoft/static/Defender_Control_v2.1.zip"
$targetDir = Join-Path $HOME 'Defender_Control_v2.1'
$zipFileName = "Defender_Control_v2.1.zip"
...
Write-Host ""
Write-Host "Defender Control v2.1" -ForegroundColor Cyan
Write-Host ""
