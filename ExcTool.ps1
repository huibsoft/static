...
# 配置参数
$zipUrl = "https://cdn.jsdmirror.com/gh/huibsoft/static/Defender_Exclusion_Tool_v1.4.zip"
$targetDir = Join-Path $HOME 'Defender_Exclusion_Tool_v1.4'
$zipFileName = "Defender_Exclusion_Tool_v1.4.zip"
...
Write-Host ""
Write-Host "Defender Exclusion Tool v1.4" -ForegroundColor Cyan
Write-Host ""
