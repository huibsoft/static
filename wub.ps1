...
# 配置参数
$zipUrl = "https://cdn.jsdmirror.com/gh/huibsoft/static/Windows_Update_Blocker_v1.8.zip"
$targetDir = Join-Path $HOME 'Windows_Update_Blocker_v1.8'
$zipFileName = "Windows_Update_Blocker_v1.8.zip"
...
Write-Host ""
Write-Host "Windows Update Blocker v1.8" -ForegroundColor Cyan
Write-Host ""
